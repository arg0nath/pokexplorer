    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            OutlinedButton(
              style: OutlinedButton.styleFrom(foregroundColor: app_const.WHITE_TOTAL, backgroundColor: app_const.BRIGHT_RED, side: const BorderSide(width: 1, color: app_const.LIGHT_RED)),
              onPressed: () {
              ...
              child: const app_widgets.MyText("Let's start!", style: TextStyle(color: app_const.WHITE_TOTAL, fontSize: 19)),
