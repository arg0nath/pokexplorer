...
Future<void> setupServiceLocator() async {
  ...
  //type selection
  sl.registerSingleton<TypeSelectionLocalSourceInterface>(sl());
  sl.registerSingleton<TypeSelectionRepository>(TypeSelectionImpl(typeSelectionSource: sl()));
  sl.registerSingleton<TypeSelectionUsecase>(TypeSelectionUsecase(typeSelectionRepository: sl()));
  sl.registerSingleton<TypeSelectionBloc>(sl());
}
