...
Future<void> setupServiceLocator() async {
  ...
  //theme
  sl.registerSingleton(ThemeLocalDatasource(sharedPreferences: sl()));
  sl.registerSingleton(ThemeRepositoryImpl(themeLocalDatasource: sl()));
  sl.registerSingleton(GetThemeUseCase(sl()));
